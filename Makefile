...
DISTDIR = /user/0/.base/bayett/home/workspace/SIA/GPGPU_TP/.tmp/myViewer1.0.0
SUBTARGETS    =  \
		sub-trimesh2 \
		sub-viewer
...
sub-trimesh2-qmake_all:  FORCE
	...
	cd trimesh2/ && $(QMAKE) /user/0/.base/bayett/home/workspace/SIA/GPGPU_TP/trimesh2/trimesh2.pro -o Makefile
	cd trimesh2/ && $(MAKE) -f Makefile qmake_all
sub-trimesh2: FORCE
	@test -d trimesh2/ || mkdir -p trimesh2/
	cd trimesh2/ && ( test -e Makefile || $(QMAKE) /user/0/.base/bayett/home/workspace/SIA/GPGPU_TP/trimesh2/trimesh2.pro -o Makefile ) && $(MAKE) -f Makefile
...
sub-trimesh2-all-ordered: FORCE
	@test -d trimesh2/ || mkdir -p trimesh2/
	cd trimesh2/ && ( test -e Makefile || $(QMAKE) /user/0/.base/bayett/home/workspace/SIA/GPGPU_TP/trimesh2/trimesh2.pro -o Makefile ) && $(MAKE) -f Makefile all
sub-trimesh2-all: FORCE
	@test -d trimesh2/ || mkdir -p trimesh2/
	cd trimesh2/ && ( test -e Makefile || $(QMAKE) /user/0/.base/bayett/home/workspace/SIA/GPGPU_TP/trimesh2/trimesh2.pro -o Makefile ) && $(MAKE) -f Makefile all
sub-trimesh2-clean-ordered: FORCE
	@test -d trimesh2/ || mkdir -p trimesh2/
	cd trimesh2/ && ( test -e Makefile || $(QMAKE) /user/0/.base/bayett/home/workspace/SIA/GPGPU_TP/trimesh2/trimesh2.pro -o Makefile ) && $(MAKE) -f Makefile clean
sub-trimesh2-clean: FORCE
	@test -d trimesh2/ || mkdir -p trimesh2/
	cd trimesh2/ && ( test -e Makefile || $(QMAKE) /user/0/.base/bayett/home/workspace/SIA/GPGPU_TP/trimesh2/trimesh2.pro -o Makefile ) && $(MAKE) -f Makefile clean
sub-trimesh2-distclean-ordered: FORCE
	@test -d trimesh2/ || mkdir -p trimesh2/
	cd trimesh2/ && ( test -e Makefile || $(QMAKE) /user/0/.base/bayett/home/workspace/SIA/GPGPU_TP/trimesh2/trimesh2.pro -o Makefile ) && $(MAKE) -f Makefile distclean
sub-trimesh2-distclean: FORCE
	@test -d trimesh2/ || mkdir -p trimesh2/
	cd trimesh2/ && ( test -e Makefile || $(QMAKE) /user/0/.base/bayett/home/workspace/SIA/GPGPU_TP/trimesh2/trimesh2.pro -o Makefile ) && $(MAKE) -f Makefile distclean
sub-trimesh2-install_subtargets-ordered: FORCE
	@test -d trimesh2/ || mkdir -p trimesh2/
	cd trimesh2/ && ( test -e Makefile || $(QMAKE) /user/0/.base/bayett/home/workspace/SIA/GPGPU_TP/trimesh2/trimesh2.pro -o Makefile ) && $(MAKE) -f Makefile install
sub-trimesh2-install_subtargets: FORCE
	@test -d trimesh2/ || mkdir -p trimesh2/
	cd trimesh2/ && ( test -e Makefile || $(QMAKE) /user/0/.base/bayett/home/workspace/SIA/GPGPU_TP/trimesh2/trimesh2.pro -o Makefile ) && $(MAKE) -f Makefile install
sub-trimesh2-uninstall_subtargets-ordered: FORCE
	@test -d trimesh2/ || mkdir -p trimesh2/
	cd trimesh2/ && ( test -e Makefile || $(QMAKE) /user/0/.base/bayett/home/workspace/SIA/GPGPU_TP/trimesh2/trimesh2.pro -o Makefile ) && $(MAKE) -f Makefile uninstall
sub-trimesh2-uninstall_subtargets: FORCE
	@test -d trimesh2/ || mkdir -p trimesh2/
	cd trimesh2/ && ( test -e Makefile || $(QMAKE) /user/0/.base/bayett/home/workspace/SIA/GPGPU_TP/trimesh2/trimesh2.pro -o Makefile ) && $(MAKE) -f Makefile uninstall
sub-viewer-qmake_all: sub-trimesh2-qmake_all FORCE
	@test -d viewer/ || mkdir -p viewer/
	cd viewer/ && $(QMAKE) /user/0/.base/bayett/home/workspace/SIA/GPGPU_TP/viewer/viewer.pro -o Makefile
	cd viewer/ && $(MAKE) -f Makefile qmake_all
sub-viewer: FORCE
	@test -d viewer/ || mkdir -p viewer/
	cd viewer/ && ( test -e Makefile || $(QMAKE) /user/0/.base/bayett/home/workspace/SIA/GPGPU_TP/viewer/viewer.pro -o Makefile ) && $(MAKE) -f Makefile
...
sub-viewer-all-ordered: sub-trimesh2-all-ordered  FORCE
	@test -d viewer/ || mkdir -p viewer/
	cd viewer/ && ( test -e Makefile || $(QMAKE) /user/0/.base/bayett/home/workspace/SIA/GPGPU_TP/viewer/viewer.pro -o Makefile ) && $(MAKE) -f Makefile all
sub-viewer-all: FORCE
	@test -d viewer/ || mkdir -p viewer/
	cd viewer/ && ( test -e Makefile || $(QMAKE) /user/0/.base/bayett/home/workspace/SIA/GPGPU_TP/viewer/viewer.pro -o Makefile ) && $(MAKE) -f Makefile all
sub-viewer-clean-ordered: sub-trimesh2-clean-ordered  FORCE
	@test -d viewer/ || mkdir -p viewer/
	cd viewer/ && ( test -e Makefile || $(QMAKE) /user/0/.base/bayett/home/workspace/SIA/GPGPU_TP/viewer/viewer.pro -o Makefile ) && $(MAKE) -f Makefile clean
sub-viewer-clean: FORCE
	@test -d viewer/ || mkdir -p viewer/
	cd viewer/ && ( test -e Makefile || $(QMAKE) /user/0/.base/bayett/home/workspace/SIA/GPGPU_TP/viewer/viewer.pro -o Makefile ) && $(MAKE) -f Makefile clean
sub-viewer-distclean-ordered: sub-trimesh2-distclean-ordered  FORCE
	@test -d viewer/ || mkdir -p viewer/
	cd viewer/ && ( test -e Makefile || $(QMAKE) /user/0/.base/bayett/home/workspace/SIA/GPGPU_TP/viewer/viewer.pro -o Makefile ) && $(MAKE) -f Makefile distclean
sub-viewer-distclean: FORCE
	@test -d viewer/ || mkdir -p viewer/
	cd viewer/ && ( test -e Makefile || $(QMAKE) /user/0/.base/bayett/home/workspace/SIA/GPGPU_TP/viewer/viewer.pro -o Makefile ) && $(MAKE) -f Makefile distclean
sub-viewer-install_subtargets-ordered: sub-trimesh2-install_subtargets-ordered  FORCE
	@test -d viewer/ || mkdir -p viewer/
	cd viewer/ && ( test -e Makefile || $(QMAKE) /user/0/.base/bayett/home/workspace/SIA/GPGPU_TP/viewer/viewer.pro -o Makefile ) && $(MAKE) -f Makefile install
...
sub-viewer-uninstall_subtargets-ordered: sub-trimesh2-uninstall_subtargets-ordered  FORCE
	@test -d viewer/ || mkdir -p viewer/
	cd viewer/ && ( test -e Makefile || $(QMAKE) /user/0/.base/bayett/home/workspace/SIA/GPGPU_TP/viewer/viewer.pro -o Makefile ) && $(MAKE) -f Makefile uninstall
...
sub-trimesh2-check_ordered:
	@test -d trimesh2/ || mkdir -p trimesh2/
	cd trimesh2/ && ( test -e Makefile || $(QMAKE) /user/0/.base/bayett/home/workspace/SIA/GPGPU_TP/trimesh2/trimesh2.pro -o Makefile ) && $(MAKE) -f Makefile check
sub-viewer-check_ordered: sub-trimesh2-check_ordered 
	@test -d viewer/ || mkdir -p viewer/
	cd viewer/ && ( test -e Makefile || $(QMAKE) /user/0/.base/bayett/home/workspace/SIA/GPGPU_TP/viewer/viewer.pro -o Makefile ) && $(MAKE) -f Makefile check
check: sub-trimesh2-check_ordered sub-viewer-check_ordered

sub-trimesh2-benchmark_ordered:
	@test -d trimesh2/ || mkdir -p trimesh2/
	cd trimesh2/ && ( test -e Makefile || $(QMAKE) /user/0/.base/bayett/home/workspace/SIA/GPGPU_TP/trimesh2/trimesh2.pro -o Makefile ) && $(MAKE) -f Makefile benchmark
sub-viewer-benchmark_ordered: sub-trimesh2-benchmark_ordered 
	@test -d viewer/ || mkdir -p viewer/
	cd viewer/ && ( test -e Makefile || $(QMAKE) /user/0/.base/bayett/home/workspace/SIA/GPGPU_TP/viewer/viewer.pro -o Makefile ) && $(MAKE) -f Makefile benchmark
...
sub-trimesh2-distdir: FORCE
	@test -d trimesh2/ || mkdir -p trimesh2/
	cd trimesh2/ && ( test -e Makefile || $(QMAKE) /user/0/.base/bayett/home/workspace/SIA/GPGPU_TP/trimesh2/trimesh2.pro -o Makefile ) && $(MAKE) -e -f Makefile distdir DISTDIR=$(DISTDIR)/trimesh2

sub-viewer-distdir: FORCE
	@test -d viewer/ || mkdir -p viewer/
	cd viewer/ && ( test -e Makefile || $(QMAKE) /user/0/.base/bayett/home/workspace/SIA/GPGPU_TP/viewer/viewer.pro -o Makefile ) && $(MAKE) -e -f Makefile distdir DISTDIR=$(DISTDIR)/viewer
